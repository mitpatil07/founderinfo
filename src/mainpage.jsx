...
const FounderWebpage = () => {
  ...
  // Function to generate website preview URL using a screenshot service
  const getWebsitePreview = (url) => {
    return `https://api.urlbox.io/v1/ca482d7e-9417-4569-90fe-80f7c5e1c781/png?url=${encodeURIComponent(url)}&width=400&height=250&quality=80&delay=1000`;
  };
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '4rem' }}>
            ...
            <div style={{ 
              ...
              {['About', 'Story', 'Connect'].map((item, idx) => (
                <a 
                  key={idx}
              ...
              <button 
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.boxShadow = '0 8px 25px rgba(250, 130, 41, 0.3)';
                }}
                onMouseLeave={(e) => {
            ...
            <div style={{
              ...
              <div style={{ padding: '1rem 0' }}>
                {[
                  ...
                  { name: 'Story', href: '#video' },
                  { name: 'Connect', href: '#platforms' }
                ].map((item, idx) => (
                  <a 
                    key={idx}
                    href={item.href} 
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.backgroundColor = 'rgba(250, 130, 41, 0.1)';
                      e.target.style.color = '#fa8229';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.backgroundColor = 'transparent';
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 1rem' }}>
          ...
          <div style={{ 
            ...
            {platforms.map((platform, index) => (
              ...
              >
                {/* Website Preview Image instead of Icon */}
                <div style={{
                  width: '100%',
                  height: '12rem',
                  borderRadius: '1rem',
                  ...
                  <img
                    src={getWebsitePreview(platform.url)}
                    alt={`${platform.title} website preview`}
                  ...
                  <div style={{
                    ...
                    {/* <ExternalLink size={32} style={{ color: platform.color, marginBottom: '0.5rem' }} /> */}
                    <span style={{ color: platform.color, fontWeight: 'bold', fontSize: '0.9rem' }}>
                      {platform.title}
                    </span>
                  </div>
